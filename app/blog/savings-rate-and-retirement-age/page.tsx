...
export const metadata: Metadata = {
  title: 'Your Savings Rate Is the Single Biggest Lever on When You Can Retire — Numrica',
  description: 'Save 10% and work 40 years. Save 50% and work 17 years. The relationship between savings rate and retirement age follows a precise mathematical curve — and the gains accelerate.',
  alternates: { canonical: 'https://numrica.com/blog/savings-rate-and-retirement-age' },
  openGraph: {
    title: 'Your Savings Rate Is the Single Biggest Lever on When You Can Retire',
    description: 'Save 10% and work 40 years. Save 50% and work 17 years. The relationship between savings rate and re',
    url: 'https://numrica.com/blog/savings-rate-and-retirement-age',
    type: 'article',
  },
}
...
<h2>The Power of Compounding and Time</h2>
...
<h2>The Cost of Delaying Savings</h2>
...
<div class="chart">
  <div class="chart-title">RETIREMENT SAVINGS BY SAVINGS RATE</div>
  <div class="bar-row">
    <div class="bar-label">10% SAVINGS RATE</div>
    <div class="bar-track"><div class="bar-fill" style="width:100%; background:#1a1a2e;"><span class="bar-value">$1,200,000</span></div></div>
  </div>
  <div class="bar-row">
    <div class="bar-label">15% SAVINGS RATE</div>
    <div class="bar-track"><div class="bar-fill" style="width:72%; background:#22c55e;"><span class="bar-value">$2,100,000</span></div></div>
  </div>
</div>
...
<div class="disclaimer">Data used in this article is based on 2023 US financial statistics and assumes a 7% annual return on investments. Individual results may vary based on market conditions, inflation, and personal financial decisions.</div>
...
const jsonLd = {
  ...
  "@graph": [
    {
      "@type": "BlogPosting",
      "headline": "Your Savings Rate Is the Single Biggest Lever on When You Can Retire",
      "description": "Save 10% and work 40 years. Save 50% and work 17 years. The relationship between savings rate and retirement age follows a precise mathematical curve — and the gains accelerate.",
      ...
      "mainEntityOfPage": {
        "@type": "WebPage",
        "@id": "https://numrica.com/blog/savings-rate-and-retirement-age"
      }
    },
    {
      "@type": "BreadcrumbList",
      "itemListElement": [
        ...
        },
        {
          "@type": "ListItem",
          "position": 3,
          "name": "Your Savings Rate Is the Single Biggest Lever on When You Can Retire"
        }
      ]
    }
  ]
