...
export const metadata: Metadata = {
  title: 'What Happens When You Only Make Minimum Payments on Five Credit Cards — Numrica',
  description: 'Five cards, $18,000 total, minimum payments only: you pay $14,000 in interest over 12 years before the last card clears. This is the math — and the way out.',
  alternates: { canonical: 'https://numrica.com/blog/minimum-payment-five-credit-cards' },
  openGraph: {
    title: 'What Happens When You Only Make Minimum Payments on Five Credit Cards',
    description: 'Five cards, $18,000 total, minimum payments only: you pay $14,000 in interest over 12 years before t',
    url: 'https://numrica.com/blog/minimum-payment-five-credit-cards',
    type: 'article',
  },
}
...
<h1>What Happens When You Only Make Minimum Payments on Five Credit Cards</h1>
...
<h2>How Long It Takes to Pay Off Debt</h2>
...
<div class="highlight">
  <p><strong>Total Interest Paid Over 20 Years:</strong> $15,000+</p>
  <p>This assumes a $10,000 balance, 18% APR, and minimum payments of $200/month.</p>
</div>
...
<h2>How to Escape the Minimum Payment Trap</h2>
...
<div class="disclaimer">This article is for educational purposes only and does not constitute financial advice. Individual results may vary based on credit score, income, and other factors.</div>
...
const jsonLd = {
  ...
  "@graph": [
    {
      "@type": "BlogPosting",
      "headline": "What Happens When You Only Make Minimum Payments on Five Credit Cards",
      "description": "Five cards, $18,000 total, minimum payments only: you pay $14,000 in interest over 12 years before the last card clears. This is the math — and the way out.",
      ...
      "mainEntityOfPage": {
        "@type": "WebPage",
        "@id": "https://numrica.com/blog/minimum-payment-five-credit-cards"
      }
    },
    {
      "@type": "BreadcrumbList",
      "itemListElement": [
        ...
        },
        {
          "@type": "ListItem",
          "position": 3,
          "name": "What Happens When You Only Make Minimum Payments on Five Credit Cards"
        }
      ]
    }
  ]
